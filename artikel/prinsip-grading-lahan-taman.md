---
article_id: TTG-05-02
title: "Prinsip Grading Lahan agar Air Mengalir Terkendali"
slug: "prinsip-grading-lahan-taman"
...
date_modified: null
parent_topic: TTG-05
primary_intent: "Mengatur high-low points, flow path, transitions, dan protection tanpa angka universal."
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/prinsip-grading-lahan-taman.html"
...
# Prinsip Grading Lahan agar Air Mengalir Terkendali

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Prinsip Grading Lahan agar Air Mengalir Terkendali”
...
- **Primary intent:** Mengatur high-low points, flow path, transitions, dan protection tanpa angka universal.
...
- **Scope boundary:** Memiliki surface grading; survey levels dimiliki TTG-03-02.
- **Final public route:** `/artikel/prinsip-grading-lahan-taman.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Prinsip Grading Lahan agar Air Mengalir Terkendali**.
...
- `TTG-05-01` → `/artikel/diagnosis-genangan-pada-taman.html` — Cara Mendiagnosis Genangan pada Taman
- `TTG-05-03` → `/artikel/memilih-sistem-drainase-taman.html` — Surface Drain, Channel, Inlet, dan Subsoil Drain
- `TTG-05-04` → `/artikel/drainase-taman-dekat-bangunan.html` — Drainase Taman di Dekat Pondasi, Dinding, dan Tetangga
...
- **Tie back to this article:** Keep the explanation specific to “Prinsip Grading Lahan agar Air Mengalir Terkendali”.
