---
article_id: TTG-13-02
title: "Subbase, Bedding, Joint, dan Drainase Paving Taman"
slug: "subbase-bedding-joint-paving-taman"
...
date_modified: null
parent_topic: TTG-13
primary_intent: "Memahami layers dan evidence yang memengaruhi settlement, water, dan repair."
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/subbase-bedding-joint-paving-taman.html"
...
# Subbase, Bedding, Joint, dan Drainase Paving Taman

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Subbase, Bedding, Joint, dan Drainase Paving Taman”
...
- **Primary intent:** Memahami layers dan evidence yang memengaruhi settlement, water, dan repair.
...
- **Scope boundary:** Tidak memberi detail universal; design tergantung soil, loads, product, dan standards.
- **Final public route:** `/artikel/subbase-bedding-joint-paving-taman.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Subbase, Bedding, Joint, dan Drainase Paving Taman**.
...
- `TTG-13-01` → `/artikel/layout-path-edging-transisi-taman.html` — Layout Path, Edging, dan Transisi dalam Taman
...
- **Tie back to this article:** Keep the explanation specific to “Subbase, Bedding, Joint, dan Drainase Paving Taman”.
