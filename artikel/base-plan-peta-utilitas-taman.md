---
article_id: TTG-03-03
title: "Membuat Base Plan dan Peta Utilitas Eksisting"
slug: "base-plan-peta-utilitas-taman"
description: "Produce reliable site dimensions, levels, plans, schedules, quantities, and field controls."
status: outline
publication_date: "2025-07-31"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TTG-03
primary_intent: "Menggabungkan survey, bangunan, drain, kabel, pipa, pohon, dan area terbatas."
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/base-plan-peta-utilitas-taman.html"
...
# Membuat Base Plan dan Peta Utilitas Eksisting

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Membuat Base Plan dan Peta Utilitas Eksisting”
- **Reader and situation:** Produce reliable site dimensions, levels, plans, schedules, quantities, and field controls.
- **Reader outcome:** Produce reliable site dimensions, levels, plans, schedules, quantities, and field controls.
- **Primary intent:** Menggabungkan survey, bangunan, drain, kabel, pipa, pohon, dan area terbatas.
...
- **Scope boundary:** Memiliki drawing baseline; verifikasi utilitas tetap membutuhkan prosedur lapangan.
- **Final public route:** `/artikel/base-plan-peta-utilitas-taman.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Membuat Base Plan dan Peta Utilitas Eksisting**.
...
- `TTG-03-01` → `/artikel/checklist-pengukuran-lapangan-taman.html` — Checklist Pengukuran Lapangan untuk Taman
- `TTG-03-02` → `/artikel/benchmark-level-kontur-landscape.html` — Benchmark, Level, dan Kontur: Data Dasar Landscape
- `TTG-03-04` → `/artikel/planting-plan-dan-plant-schedule.html` — Isi Planting Plan dan Plant Schedule yang Perlu Disepakati
- `TTG-03-05` → `/artikel/menghitung-quantity-pekerjaan-taman.html` — Cara Menghitung Quantity Tanaman, Media, Mulsa, dan Edging
...
- **Tie back to this article:** Keep the explanation specific to “Membuat Base Plan dan Peta Utilitas Eksisting”.
