---
article_id: TTG-17-04
title: "TDS, SDS, Test Report, dan Product Certificate dalam Landscape"
slug: "dokumen-produk-landscape"
...
date_modified: null
parent_topic: TTG-17
primary_intent: "Memahami fungsi dan batas dokumen soil, chemical, membrane, pipe, lighting, dan materials."
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/dokumen-produk-landscape.html"
...
# TDS, SDS, Test Report, dan Product Certificate dalam Landscape

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “TDS, SDS, Test Report, dan Product Certificate dalam Landscape”
...
- **Primary intent:** Memahami fungsi dan batas dokumen soil, chemical, membrane, pipe, lighting, dan materials.
...
- **Scope boundary:** Memiliki product evidence; tidak memperluas result ke produk atau kondisi yang tidak diuji.
- **Final public route:** `/artikel/dokumen-produk-landscape.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **TDS, SDS, Test Report, dan Product Certificate dalam Landscape**.
...
- `TTG-17-02` → `/artikel/menentukan-standar-elemen-taman.html` — Cara Menentukan Standar yang Berlaku pada Elemen Taman
...
- `TTG-17-05` → `/artikel/risk-assessment-method-statement-landscape.html` — Risk Assessment dan Method Statement Pekerjaan Taman
...
- **Tie back to this article:** Keep the explanation specific to “TDS, SDS, Test Report, dan Product Certificate dalam Landscape”.
