---
article_id: TTG-03-05
title: "Cara Menghitung Quantity Tanaman, Media, Mulsa, dan Edging"
slug: "menghitung-quantity-pekerjaan-taman"
...
date_modified: null
parent_topic: TTG-03
primary_intent: "Menyusun takeoff terukur dari drawing dan allowance yang transparan."
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/menghitung-quantity-pekerjaan-taman.html"
...
# Cara Menghitung Quantity Tanaman, Media, Mulsa, dan Edging

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cara Menghitung Quantity Tanaman, Media, Mulsa, dan Edging”
...
- **Primary intent:** Menyusun takeoff terukur dari drawing dan allowance yang transparan.
...
- **Scope boundary:** Memiliki quantity method; unit price dan quotation dimiliki TTG-16.
- **Final public route:** `/artikel/menghitung-quantity-pekerjaan-taman.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara Menghitung Quantity Tanaman, Media, Mulsa, dan Edging**.
...
- `TTG-03-03` → `/artikel/base-plan-peta-utilitas-taman.html` — Membuat Base Plan dan Peta Utilitas Eksisting
- `TTG-03-04` → `/artikel/planting-plan-dan-plant-schedule.html` — Isi Planting Plan dan Plant Schedule yang Perlu Disepakati
- `TTG-03-06` → `/artikel/setting-out-toleransi-elemen-taman.html` — Setting Out dan Toleransi Posisi Elemen Taman
...
- **Tie back to this article:** Keep the explanation specific to “Cara Menghitung Quantity Tanaman, Media, Mulsa, dan Edging”.
