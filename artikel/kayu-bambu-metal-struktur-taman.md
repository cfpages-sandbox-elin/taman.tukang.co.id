---
article_id: TTG-14-03
title: "Kayu, Bambu, atau Metal untuk Struktur Taman"
slug: "kayu-bambu-metal-struktur-taman"
...
date_modified: null
parent_topic: TTG-14
primary_intent: "Membandingkan exposure, connection, treatment, corrosion, inspection, repair, dan evidence."
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/kayu-bambu-metal-struktur-taman.html"
...
# Kayu, Bambu, atau Metal untuk Struktur Taman

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kayu, Bambu, atau Metal untuk Struktur Taman”
...
- **Primary intent:** Membandingkan exposure, connection, treatment, corrosion, inspection, repair, dan evidence.
...
- **Scope boundary:** Pemilihan material awal; tidak menjamin strength atau durability tanpa desain dan data.
- **Final public route:** `/artikel/kayu-bambu-metal-struktur-taman.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kayu, Bambu, atau Metal untuk Struktur Taman**.
...
- `/gazebo-kayu-bambu/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `TTG-14-01` → `/artikel/checklist-scope-gazebo.html` — Checklist Scope Gazebo Sebelum Desain Struktur
...
- **Tie back to this article:** Keep the explanation specific to “Kayu, Bambu, atau Metal untuk Struktur Taman”.
