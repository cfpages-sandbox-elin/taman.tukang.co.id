---
article_id: TTG-13-03
title: "Carport dalam Landscape: Beban, Air, dan Akar"
slug: "carport-landscape-beban-air-akar"
...
date_modified: null
parent_topic: TTG-13
primary_intent: "Mengkoordinasikan vehicle load, turning, slope, drainage, tree roots, dan surface finish."
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/carport-landscape-beban-air-akar.html"
...
# Carport dalam Landscape: Beban, Air, dan Akar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Carport dalam Landscape: Beban, Air, dan Akar”
...
- **Primary intent:** Mengkoordinasikan vehicle load, turning, slope, drainage, tree roots, dan surface finish.
...
- **Scope boundary:** Tidak melakukan pavement sizing; engineering dan vehicle data tetap diperlukan.
- **Final public route:** `/artikel/carport-landscape-beban-air-akar.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Carport dalam Landscape: Beban, Air, dan Akar**.
...
- `/carport-lantai/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `TTG-13-02` → `/artikel/subbase-bedding-joint-paving-taman.html` — Subbase, Bedding, Joint, dan Drainase Paving Taman
...
- **Tie back to this article:** Keep the explanation specific to “Carport dalam Landscape: Beban, Air, dan Akar”.
