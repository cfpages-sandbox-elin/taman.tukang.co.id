---
article_id: TTG-04-04
title: "Spesifikasi Topsoil dan Growing Media untuk Landscape"
slug: "spesifikasi-topsoil-growing-media"
...
date_modified: null
parent_topic: TTG-04
primary_intent: "Menentukan sumber, composition, contaminants, physical properties, testing, dan acceptance."
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/spesifikasi-topsoil-growing-media.html"
...
# Spesifikasi Topsoil dan Growing Media untuk Landscape

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Spesifikasi Topsoil dan Growing Media untuk Landscape”
...
- **Primary intent:** Menentukan sumber, composition, contaminants, physical properties, testing, dan acceptance.
...
- **Scope boundary:** Memiliki material soil; media ringan rooftop dimiliki TTG-10-04.
- **Final public route:** `/artikel/spesifikasi-topsoil-growing-media.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Spesifikasi Topsoil dan Growing Media untuk Landscape**.
...
- `TTG-04-06` → `/artikel/amendment-bahan-organik-untuk-tanah.html` — Amendment dan Bahan Organik: Bukti Sebelum Dicampurkan
...
- **Tie back to this article:** Keep the explanation specific to “Spesifikasi Topsoil dan Growing Media untuk Landscape”.
