---
article_id: TTG-07-04
title: "Mencocokkan Tanaman dengan Tanah, Air, dan Iklim Mikro"
slug: "tanaman-tanah-air-iklim-mikro"
...
date_modified: null
parent_topic: TTG-07
primary_intent: "Menggunakan site evidence untuk menyaring kandidat tanaman."
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/tanaman-tanah-air-iklim-mikro.html"
...
# Mencocokkan Tanaman dengan Tanah, Air, dan Iklim Mikro

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mencocokkan Tanaman dengan Tanah, Air, dan Iklim Mikro”
...
- **Primary intent:** Menggunakan site evidence untuk menyaring kandidat tanaman.
...
- **Scope boundary:** Tidak membuat daftar location swap; setiap rekomendasi harus punya kondisi dan sumber.
- **Final public route:** `/artikel/tanaman-tanah-air-iklim-mikro.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mencocokkan Tanaman dengan Tanah, Air, dan Iklim Mikro**.
...
- `TTG-07-03` → `/artikel/akar-tajuk-tanaman-dan-infrastruktur.html` — Ukuran Tajuk dan Akar Matang terhadap Bangunan dan Utilitas
- `TTG-07-05` → `/artikel/risiko-tanaman-di-area-pengguna.html` — Duri, Buah Jatuh, Getah, dan Toksisitas di Area Pengguna
- `TTG-07-06` → `/artikel/tanaman-lokal-introduksi-risiko-invasif.html` — Tanaman Lokal, Introduksi, dan Risiko Invasif
...
- **Tie back to this article:** Keep the explanation specific to “Mencocokkan Tanaman dengan Tanah, Air, dan Iklim Mikro”.
