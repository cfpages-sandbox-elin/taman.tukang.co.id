---
article_id: TTG-05-04
title: "Drainase Taman di Dekat Pondasi, Dinding, dan Tetangga"
slug: "drainase-taman-dekat-bangunan"
description: "Direct surface and subsurface water without creating ponding, erosion, or damage to buildings and neighbours."
status: outline
publication_date: "2025-09-16"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TTG-05
primary_intent: "Mengidentifikasi interface air yang dapat merusak bangunan atau memindahkan masalah."
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/drainase-taman-dekat-bangunan.html"
...
# Drainase Taman di Dekat Pondasi, Dinding, dan Tetangga

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Drainase Taman di Dekat Pondasi, Dinding, dan Tetangga”
- **Reader and situation:** Direct surface and subsurface water without creating ponding, erosion, or damage to buildings and neighbours.
- **Reader outcome:** Direct surface and subsurface water without creating ponding, erosion, or damage to buildings and neighbours.
- **Primary intent:** Mengidentifikasi interface air yang dapat merusak bangunan atau memindahkan masalah.
...
- **Scope boundary:** Berfokus pada boundary risk; tidak menggantikan desain sipil atau waterproofing.
- **Final public route:** `/artikel/drainase-taman-dekat-bangunan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Drainase Taman di Dekat Pondasi, Dinding, dan Tetangga**.
...
- `TTG-05-02` → `/artikel/prinsip-grading-lahan-taman.html` — Prinsip Grading Lahan agar Air Mengalir Terkendali
- `TTG-05-03` → `/artikel/memilih-sistem-drainase-taman.html` — Surface Drain, Channel, Inlet, dan Subsoil Drain
- `TTG-05-05` → `/artikel/kontrol-erosi-sedimen-proyek-landscape.html` — Erosi dan Sedimen Selama Pekerjaan Landscape
- `TTG-05-06` → `/artikel/overflow-maintenance-drainase-taman.html` — Overflow dan Maintenance Sistem Drainase Taman
...
- **Tie back to this article:** Keep the explanation specific to “Drainase Taman di Dekat Pondasi, Dinding, dan Tetangga”.
