---
article_id: TTG-10-02
title: "Angin, Panas, dan Paparan pada Tanaman Rooftop"
slug: "angin-panas-tanaman-rooftop"
...
date_modified: null
parent_topic: TTG-10
primary_intent: "Memetakan exposure dan memilih response design serta monitoring."
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/angin-panas-tanaman-rooftop.html"
...
# Angin, Panas, dan Paparan pada Tanaman Rooftop

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Angin, Panas, dan Paparan pada Tanaman Rooftop”
...
- **Primary intent:** Memetakan exposure dan memilih response design serta monitoring.
...
- **Scope boundary:** Khusus roof microclimate; species selection framework dimiliki TTG-07.
- **Final public route:** `/artikel/angin-panas-tanaman-rooftop.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Angin, Panas, dan Paparan pada Tanaman Rooftop**.
...
- `TTG-10-01` → `/artikel/checklist-kelayakan-taman-rooftop.html` — Checklist Kelayakan Taman Rooftop Sebelum Desain
- `TTG-10-03` → `/artikel/drainase-rooftop-garden.html` — Drainase Rooftop Garden Tanpa Menghalangi Roof Outlet
- `TTG-10-04` → `/artikel/growing-media-beban-basah-rooftop.html` — Growing Media dan Beban Basah pada Taman Atap
...
- **Tie back to this article:** Keep the explanation specific to “Angin, Panas, dan Paparan pada Tanaman Rooftop”.
