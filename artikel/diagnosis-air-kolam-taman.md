---
article_id: TTG-12-04
title: "Diagnosis Air Kolam Keruh, Hijau, Berbau, atau Berbusa"
slug: "diagnosis-air-kolam-taman"
description: "Define purpose, containment, hydraulics, water quality, access, edge safety, planting, and maintenance."
status: outline
publication_date: "2026-02-24"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TTG-12
primary_intent: "Menelusuri source, load, circulation, light, nutrients, biota, dan maintenance."
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/diagnosis-air-kolam-taman.html"
...
# Diagnosis Air Kolam Keruh, Hijau, Berbau, atau Berbusa

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Diagnosis Air Kolam Keruh, Hijau, Berbau, atau Berbusa”
- **Reader and situation:** Define purpose, containment, hydraulics, water quality, access, edge safety, planting, and maintenance.
- **Reader outcome:** Define purpose, containment, hydraulics, water quality, access, edge safety, planting, and maintenance.
- **Primary intent:** Menelusuri source, load, circulation, light, nutrients, biota, dan maintenance.
...
- **Scope boundary:** Diagnosis awal; tidak memberi dosis chemical atau klaim kesehatan.
- **Final public route:** `/artikel/diagnosis-air-kolam-taman.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Diagnosis Air Kolam Keruh, Hijau, Berbau, atau Berbusa**.
...
- `/kolam-ikan/` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TTG-12-02` → `/artikel/liner-beton-waterproofing-kolam-taman.html` — Liner, Beton, dan Waterproofing Kolam Taman
- `TTG-12-03` → `/artikel/pompa-filter-sirkulasi-water-feature.html` — Pompa, Filter, Sirkulasi, dan Overflow Water Feature
- `TTG-12-05` → `/artikel/keselamatan-tepi-kolam-taman.html` — Tepi Kolam, Slip, Kedalaman, dan Keselamatan Pengguna
- `TTG-12-06` → `/artikel/tanaman-air-ikan-kolam-landscape.html` — Tanaman Air dan Ikan dalam Kolam Landscape
...
- **Tie back to this article:** Keep the explanation specific to “Diagnosis Air Kolam Keruh, Hijau, Berbau, atau Berbusa”.
