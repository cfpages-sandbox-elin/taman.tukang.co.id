---
article_id: TTG-10-04
title: "Growing Media dan Beban Basah pada Taman Atap"
slug: "growing-media-beban-basah-rooftop"
description: "Plan low-water or roof-based landscapes around loads, membranes, drainage, wind, heat, and access."
status: outline
publication_date: "2026-01-13"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TTG-10
primary_intent: "Menyiapkan data density, saturation, depth, plant, retained water, dan load combinations."
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/growing-media-beban-basah-rooftop.html"
...
# Growing Media dan Beban Basah pada Taman Atap

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Growing Media dan Beban Basah pada Taman Atap”
- **Reader and situation:** Plan low-water or roof-based landscapes around loads, membranes, drainage, wind, heat, and access.
- **Reader outcome:** Plan low-water or roof-based landscapes around loads, membranes, drainage, wind, heat, and access.
- **Primary intent:** Menyiapkan data density, saturation, depth, plant, retained water, dan load combinations.
...
- **Scope boundary:** Tidak melakukan structural sizing; soil media umum dimiliki TTG-04-04.
- **Final public route:** `/artikel/growing-media-beban-basah-rooftop.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Growing Media dan Beban Basah pada Taman Atap**.
...
- `TTG-10-02` → `/artikel/angin-panas-tanaman-rooftop.html` — Angin, Panas, dan Paparan pada Tanaman Rooftop
- `TTG-10-03` → `/artikel/drainase-rooftop-garden.html` — Drainase Rooftop Garden Tanpa Menghalangi Roof Outlet
- `TTG-10-05` → `/artikel/merancang-taman-kering.html` — Merancang Taman Kering yang Tetap Sesuai Site
- `TTG-10-06` → `/artikel/akses-keselamatan-rooftop-garden.html` — Akses, Kebakaran, dan Keselamatan pada Rooftop Garden
...
- **Tie back to this article:** Keep the explanation specific to “Growing Media dan Beban Basah pada Taman Atap”.
